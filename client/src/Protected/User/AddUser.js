        ...
        <CircularProgress color="inherit" />
					...
					<form onSubmit={(e) => handleSubmit(e)} style={{ maxWidth: "100vw" }}>
						<Grid container spacing={2}>
							...
							<Grid item xs={4}>
								<center>
									<Chip color="primary" label="Add Users" />
								</center>
							</Grid>
							<Grid item xs={4}></Grid>
							<Grid item xs={6}>
 ...
 <>  
  ...
  <Grid item xs={12} md={6}> 
            ...
            />
				...
				{/* <SearchBar name={ "User"}  onChange={(e) => getData(e.target.value)} /> */}
							...
							<TableBody>
								{allUser.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((data) => (
									<TableRow key={data._id} onClick={() => setData(data._id)} hover>
										...
										<TableCell align="right">{data.mobileNo}</TableCell>
										<TableCell align="center">{data.designation.label}</TableCell>
