...
import BusinessImgPrevDeleteCom from "./../Business/BusinessImgPrevDelete";
import TermAndConCom from "./../Business/TermAndCon";
import PrevPageCom from "./../Business/PrevPage";
import OtpDialogCom from "./../Business/OtpDialog";
import VerifyFieldsFun from "./../Business/VerifyFields";
import {
	Grid,
	Chip,
	Paper,
...
link:""
	...
	const handleSubmit = async (e) => {
		...
		await axios
			.post(`/api/v1/addition/business/addBusiness/${id}`, newCat)
			.then((res) => {
...
// console.log(newAllImg)
	...
	const imgUpload = async (e, name) => {
		if (e) {
			...
			let link = `/api/v1/other/fileupload/mainfolder/businessImage`
					...
					<form onSubmit={(e) => checkBeforeSubmit(e)} style={{ maxWidth: "100vw" }}>
						...
						<Grid container spacing={2}>
							...
							<span style={{flexGrow:1.1}}/>
									...
									<IconButton color="primary" href="/GetBusiness"  rel="noopener noreferrer">
									<FindInPageIcon />
						...
						)} 
							{
								allImage.length <= 4 && (
									...
									// required
										...
										label={err.errIn === "image" ? err.msg : "Business Image"}
